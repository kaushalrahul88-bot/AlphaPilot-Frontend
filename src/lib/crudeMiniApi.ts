...
export interface CrudeMiniResult {
  ...
  data?: { candles?: number; candle_source?: string; option_positioning?: any; news?: any; global_context?: Record<string,string>; expensive_180_day_live_refetch_used?: boolean };
