import { LayoutDashboard, LineChart, Wallet, Layers, Brain, Target, Calculator, BookOpen, ShieldAlert, Newspaper, Bell, Settings, Menu, X, ScanLine, FlaskConical, BarChart3, Activity } from 'lucide-react';
import { useState } from 'react';

export type PageKey = 'dashboard' | 'markets' | 'portfolio' | 'options' | 'ai-analyst' | 'trade-scanner' | 'live-validation' | 'backtest' | 'direction-diagnostics' | 'trade-setup' | 'position-sizing' | 'journal' | 'risk' | 'news' | 'alerts' | 'settings';
