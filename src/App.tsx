...
import { MarketBrainArchetypeContextResearch } from '@/components/MarketBrainArchetypeContextResearch';
import { MarketBrainDynamicContextResearch } from '@/components/MarketBrainDynamicContextResearch';
import { MarketBrainContinuousRegimeResearch } from '@/components/MarketBrainContinuousRegimeResearch';
import { SetupDiscoveryV2 } from '@/components/SetupDiscoveryV2';
import { ExecutionStructureDiscoveryV1 } from '@/components/ExecutionStructureDiscoveryV1';
import { CandidateHExecutionValidator } from '@/components/CandidateHExecutionValidator';
import { CandidateHOptionValidator } from '@/components/CandidateHOptionValidator';
import { CandidateHDayReplay } from '@/components/CandidateHDayReplay';
import { CandidateHMonthReplay } from '@/components/CandidateHMonthReplay';
import { CandlestickDiscoveryV2 } from '@/components/CandlestickDiscoveryV2';
import { CandlestickDiscoveryV1 } from '@/components/CandlestickDiscoveryV1';
import { CandidateGValidator } from '@/components/CandidateGValidator';
import { CandidateFValidator } from '@/components/CandidateFValidator';
import { CandidateEValidator } from '@/components/CandidateEValidator';
import { CandidateCValidator } from '@/components/CandidateCValidator';
import { CandidateDValidator } from '@/components/CandidateDValidator';
