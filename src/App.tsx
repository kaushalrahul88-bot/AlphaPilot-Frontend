...
function AppContent() {
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case 'backtest': return <div className="space-y-5"><MarketRegimeResearch /><OptionNativePhase2 /><OptionNativeResearchV3 /><StrategyResearchPanel /><StrategyPremiumReplay /><FnoHistoryProbe /><FnoPremiumBacktest /><Backtest /></div>;
